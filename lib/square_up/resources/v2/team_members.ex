defmodule SquareUp.V2.TeamMembers do
  ...
  def search(client, params \\ %{}) do
    norm_spec = Norm.Delegate.delegate(&SquareUp.NormSchema.search_team_members_request/0)
  ...
  @spec bulk_update(SquareUp.Client.t(), SquareUp.TypeSpecs.bulk_update_team_members_request()) ::
          SquareUp.Client.response(SquareUp.TypeSpecs.bulk_update_team_members_response())
  def bulk_update(client, params \\ %{}) do
    norm_spec = Norm.Delegate.delegate(&SquareUp.NormSchema.bulk_update_team_members_request/0)
